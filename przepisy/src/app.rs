...
//<Theme_wrapper>
    ...
    <div class="grid h-full max-w-lg grid-cols-6 mx-auto">
        ...
        <button on:click=move |_| {set_view_state.set(CurrentView::Home); set_page_counter_vis.set(true);} data-tooltip-target="tooltip-bookmark" type="button" class="inline-flex flex-col items-center justify-center px-5 hover:bg-background/50 group transition-colors">
        ...
        <div class="flex items-center justify-center col-span-2">
            <div class="flex items-center justify-between w-full text-text-muted bg-background rounded-base border border-text-muted/20 max-w-[128px] mx-2 shadow-inner">
                <button type="button" class="inline-flex items-center justify-center h-8 px-1 w-6 rounded-s-base hover:bg-primary/10 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors">
                ...
                <span class="shrink-0 mx-1 text-sm font-medium text-text-main space-x-0.5 rtl:space-x-reverse">1 of 34</span>
                <button type="button" class="inline-flex items-center justify-center h-8 px-1 w-6 rounded-e-base hover:bg-primary/10 hover:text-primary focus:outline-none focus:ring-2 focus:ring-primary/50 transition-colors">
